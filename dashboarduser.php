...
?>
  ...
  <body>
    ...
    if ($monequipe !== NULL) {
      ...
      $nomdelequipe = 'YOU STILL WITHOUT A TEAM';
    }
      ...
      <div class="burgermenu lg:pl-64 flex flex-col flex-1">
        ...
        <main class="flex-1 ">
          ...
          <dl class='mt-1 flex-grow '>
            ...
            <h4> ". ($monequipe !== NULL ? "your team is :" : "") ."</h4>
            <dd class='mt-3'>
            
            
              <span class='px-2 py-1 text-black text-xs font-medium bg-" . ($monequipe == NULL ? "red-400" : "green-100") . " rounded-full'>$nomdelequipe</span>
              </dd>
          </dl>
        </div>
